...
#importing api to scrape reddit
import praw
import pandas as pd
from PIL import Image
from io import BytesIO
import requests
#creating function to get posts
...
# getting post info including: subbredit, title, image url, upvotes and date    
    posts = []
...
# keywords used to search for posts
